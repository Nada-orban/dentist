      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2">
          ...
          <div className="border-r border-primary-color ">
            <h6
              className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start text-primary-color">
              {/* <svg
          ...
          <div className='grid grid-cols-3'>
            <div className="">
              <h6
                className="mb-4 flex justify-center font-semibold uppercase  text-primary-color">
                PRACTICE
              </h6>
              <p className="mb-4">
