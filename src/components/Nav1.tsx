...
export default function Example() {
  ...
  const handleLogout = () => {
    ...
    setIsLoggedIn(false);
    router.push("/register/signIn"); // or homepage
  };
  const handleLogin = () => {
    router.push("/login");
  };
        ...
        <div className="hidden lg:block">
          <div className="flex justify-end items-center">
            <p className="text-primary-color capitalize">
              call us now: <span className="text-gray-100">01032946286</span>
            </p>
          </div>
          <div className="flex items-center ">
            <PopoverGroup className="hidden lg:flex lg:gap-x-10">
              <a
                href=""
                className="text-md font-semibold leading-6 text-white no-underline"
              >
                About
              </a>
                      ...
                      {products.map((item) => (
                        ...
                        >
                          <div className="flex-auto">
                            <a
                              href={item.href}
                              className="block font-semibold text-white no-underline"
                            >
                              {item.name}
                              <span className="absolute inset-0" />
                            </a>
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="pointer-events-none fixed inset-y-0 right-0 flex  pl-10">
                <DialogPanel
                  transition
                  className={`pointer-events-auto relative w-screen h-full bg-white  transform transition-all duration-700 ease-in-out  ${
                      ...
                      <div className="mt-6 flow-root">
                        <div className="-my-6 divide-y divide-gray-500/10">
                          <div className="space-y-2 py-6">
                            <a
                              href="/"
                              className="-mx-4 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-primary-color no-underline"
                            >
                              Home
                            </a>
